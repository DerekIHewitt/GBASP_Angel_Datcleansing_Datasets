...
CREATE PROCEDURE [dbo].[USP_RPT_DATA_DEFECT_CURRENT_DETAIL_DATA]
@PARAM_OWNER_GROUP INT
...
SELECT 
	...
	DETAIL_DATA_DEFECT_VALUE				=	CASE	WHEN ISNULL(DD.BadValue,'') <> '' THEN DD.BadValue
	...
	WHERE RUO.ID = @PARAM_OWNER_GROUP
