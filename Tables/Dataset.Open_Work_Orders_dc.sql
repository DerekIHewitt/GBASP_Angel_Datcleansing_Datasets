CREATE TABLE [Dataset].[Open_Work_Orders_dc]
(
...
[MIG_COMMENT] [varchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_Open_Work_Orders_dc_MIG_COMMENT] DEFAULT (''),
[MIG_CREATED_DATE] [datetime] NOT NULL CONSTRAINT [DF_Open_Work_Orders_dc_MIG_CREATED_DATE] DEFAULT (getdate())
) ON [PRIMARY]
GO
ALTER TABLE [Dataset].[Open_Work_Orders_dc] ADD CONSTRAINT [PK_Open_Work_Orders_dc] PRIMARY KEY CLUSTERED  ([ID]) ON [PRIMARY]
GO
