CREATE TABLE [Dataset].[Customer_BillingRules_dc]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
[MIG_SITE_NAME] [nvarchar] (5) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[MIG_COMMENT] [varchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_Customer_BillingRules_dc_MIG_COMMENT] DEFAULT (''),
[MIG_CREATED_DATE] [datetime] NOT NULL CONSTRAINT [DF_Customer_BillingRules_dc_MIG_CREATED_DATE] DEFAULT (getdate()),
...
GO
ALTER TABLE [Dataset].[Customer_BillingRules_dc] ADD CONSTRAINT [PK_Customer_BillingRules_dc] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
