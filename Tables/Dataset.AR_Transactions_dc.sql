CREATE TABLE [Dataset].[AR_Transactions_dc]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
[MIG_SITE_NAME] [varchar] (5) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[MIG_CREATED] [datetime] NOT NULL CONSTRAINT [DF_Table_1_Mig_CREATED] DEFAULT (getdate()),
[MIG_COMMENT] [varchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_AR_Transactions_dc_MIG_COMMENT] DEFAULT (''),
...
GO
ALTER TABLE [Dataset].[AR_Transactions_dc] ADD CONSTRAINT [PK_AR_Transactions_dc] PRIMARY KEY CLUSTERED  ([ID]) ON [PRIMARY]
GO
