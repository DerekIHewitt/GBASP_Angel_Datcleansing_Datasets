...
[SRC_BR_ORDER_TYPE] [nvarchar] (30) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_Customer_Header_ovl_SRC_BR_ORDER_TYPE] DEFAULT (''),
[SRC_BR_BLOCKED_DD] [nvarchar] (5) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_Customer_Header_ovl_SRC_BR_BLOCKED_DD] DEFAULT (''),
[SRC_BR_CONSOLIDATION] [nvarchar] (30) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_Customer_Header_ovl_SRC_BR_CONSOLIDATION] DEFAULT (''),
[SRC_IMPORT_ACCOUNT] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_Customer_Header_ovl_SRC_IMPORT_ACCOUNT] DEFAULT (''),
[SRC_FILTER_STATUS] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_Customer_Header_ovl_SRC_FILTER_STATUS] DEFAULT (''),
[SRC_LEGAL_ENTITY_DB] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_Customer_Header_ovl_SRC_LEGAL_ENTITY_DB] DEFAULT (''),
[SRC_CUST_GROUP] [nvarchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_Customer_Header_ovl_SRC_CUST_GROUP] DEFAULT (''),
[SRC_CURRENCY] [nvarchar] (3) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_Customer_Header_ovl_SRC_CURRENCY] DEFAULT (''),
[SRC_REMINDER_TEMPLATE] [nvarchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_Customer_Header_ovl_SRC_REMINDER_TEMPLATE] DEFAULT (''),
...
[CUST_GROUP] [nvarchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[CURRENCY] [nvarchar] (3) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[REMINDER_TEMPLATE] [nvarchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
