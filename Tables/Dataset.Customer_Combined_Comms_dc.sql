CREATE TABLE [Dataset].[Customer_Combined_Comms_dc]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
[MIG_SITE_NAME] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[MIG_COMMENT] [varchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_Customer_Combined_Comms_dc_MIG_COMMENT] DEFAULT (''),
[MIG_CREATED_DATE] [datetime] NOT NULL CONSTRAINT [DF_Customer_Combined_Comms_dc_MIG_CREATED_DATE] DEFAULT (getdate()),
...
GO
ALTER TABLE [Dataset].[Customer_Combined_Comms_dc] ADD CONSTRAINT [PK_Customer_Combined_Comms_dc] PRIMARY KEY CLUSTERED  ([ID]) ON [PRIMARY]
GO
EXEC sp_addextendedproperty N'MS_Description', N'', 'SCHEMA', N'Dataset', 'TABLE', N'Customer_Combined_Comms_dc', 'COLUMN', N'CUSTOMER_ID'
GO
