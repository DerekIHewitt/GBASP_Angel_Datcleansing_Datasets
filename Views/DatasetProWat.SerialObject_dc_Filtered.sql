...
'' [NX_LONGITUDE], 'IN_OPERATION' AS NX_OPERATIONAL_STATUS, ISNULL(HAS_PEDAL, '') AS NX_HAS_PEDAL, Dataset.Filter_SerialObject('GBASP', 'dc', ISNULL(Dataset.SerialObject_Filter_Override.IsAlwaysIncluded, 0), 
