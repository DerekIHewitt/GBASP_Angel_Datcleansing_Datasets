...
SELECT Dataset.Customer_Header_dc.ID, Dataset.Customer_Header_dc.MIG_SITE_NAME, Dataset.Customer_Header_dc.MIG_COMMENT, Dataset.Customer_Header_dc.MIG_CREATED_DATE, Dataset.Customer_Header_dc.CUSTOMER_ID, Dataset.Customer_Header_dc.NAME, 
             ...
             Dataset.Customer_Header_dc.EMAIL_INVOICE_DB, Dataset.Customer_Header_dc.CRM_ACCOUNT_TYPE, Dataset.Customer_Header_dc.PAYMENT_METHOD, Dataset.Customer_Header_dc.PAY_ADDR_DESCRIPTION, Dataset.Customer_Header_dc.PAY_ADDR_ACCOUNT, 
             Dataset.Customer_Header_dc.PAY_ADDR_SORT_CODE, Dataset.Customer_Header_dc.PAY_ADDR_ACC_NAME, Dataset.Customer_Header_dc.NX_PAY_ADDR_BUILD_SOC_REF, Dataset.Customer_Header_dc.NX_PAY_ADDR_TRANS_CODE, 
             Dataset.Customer_Header_dc.NX_PAY_ADDR_OUR_REF, Dataset.Customer_Header_dc.CREDIT_ANALYST, Dataset.Customer_Header_dc.ACQUIRED_FROM_COMP, Dataset.Customer_Header_dc.ASSOCIATION_NO, Dataset.Customer_Header_dc.NX_CREDIT_BLOCK, 
             Dataset.Customer_Header_dc.NX_MAIN_REP, Dataset.Customer_Header_dc.NX_INVOICE_FEE, Dataset.Customer_Header_dc.NX_PRINT_TAX_CODE_TEXT, Dataset.Customer_Header_dc.NX_CYCLE_PERIOD, Dataset.Customer_Header_dc.NX_ORDER_CONF_FLAG_DB, 
             Dataset.Customer_Header_dc.NX_PACK_LIST_FLAG_DB, Dataset.Customer_Header_dc.NX_CATEGORY_DB, Dataset.Customer_Header_dc.NX_SUMMARIZED_SOURCE_LINES_DB, Dataset.Customer_Header_dc.NX_PRINT_AMOUNTS_INCL_TAX_DB, 
             Dataset.Customer_Header_dc.NX_CREDIT_CONTROL_GROUP_ID, Dataset.Customer_Header_dc.NX_CUST_PRICE_GROUP_ID, Dataset.Customer_Header_dc.NX_GROUP_ID, Dataset.Customer_Header_dc.NX_TAX_CODE, Dataset.Customer_Header_dc.NX_CUST_GRP, 
             ...
             Dataset.Customer_Header_dc.NX_DEFAULT_PAYMENT_METHOD, Dataset.Customer_Header_dc.NX_ACTIVE_TRIAL_DB, Dataset.Customer_Header_dc.NX_CCA_FLAG_DB, Dataset.Customer_Header_dc.NX_BLANKET_PURCHASE_ORDER, 
             Dataset.Customer_Header_dc.NX_PO_EXPIRY_DATE, Dataset.Customer_Header_dc.NX_PO_EXPIRY_VALUE, Dataset.Customer_Header_dc.NX_PO_VALUE_USED, Dataset.Customer_Header_dc.NX_MESSAGE_GROUP, 
             Dataset.Customer_Header_dc.NX_ALLOWED_OVERDUE_AMOUNT, Dataset.Customer_Header_dc.NX_ALLOWED_OVERDUE_DAYS, Dataset.Customer_Header_dc.NX_CREDIT_RELATIONSHIP_EXIST, Dataset.Customer_Header_dc.NX_CREDIT_RELATIONSHIP_TYPE_DB, 
             Dataset.Customer_Header_dc.NX_PARENT_COMPANY, Dataset.Customer_Header_dc.NX_PARENT_CUSTOMER_ID, Dataset.Customer_Header_dc.NX_CUST_ORDER_INVOICING_DB, Dataset.Customer_Header_dc.NX_CUST_ORDER_INV_TYPE_DB, 
...
WHERE (Dataset.Filter_Customer(Dataset.Customer_Header_dc.MIG_SITE_NAME, 'dc', ISNULL(Dataset.Customer_Filter_Override.isAlwaysIncluded, 0), ISNULL(Dataset.Customer_Filter_Override.IsAlwaysExcluded, 0), ISNULL(Dataset.Customer_Filter_Override.IsOnSubSetList, 0), 
             Dataset.Customer_Header_dc.CUSTOMER_ID, Dataset.Customer_Header_dc.NAME, Dataset.Customer_Header_dc.CRM_ACCOUNT_TYPE) > 0)
GO
